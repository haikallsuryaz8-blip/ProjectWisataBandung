...
@section('title', 'Edit Destinasi - ' . $place->name)

@section('content')
<!-- Hero Section -->
<section class="py-5" style="background: linear-gradient(135deg, rgba(26, 26, 46, 0.8) 0%, rgba(83, 52, 131, 0.6) 100%);">
    <div class="container text-center" data-aos="fade-up">
        <h1 class="hero-title" style="font-size: 3rem;">Edit Destinasi Wisata</h1>
        <p class="text-light opacity-75">Update informasi destinasi wisata "{{ $place->name }}"</p>
    </div>
</section>
                ...
                <div style="background: var(--glass-bg); backdrop-filter: blur(20px); border: 1px solid var(--glass-border); border-radius: 25px; padding: 3rem;">
                    <form action="{{ route('admin.places.update', $place) }}" method="POST" enctype="multipart/form-data" id="placeForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control glass-input @error('name') is-invalid @enderror"
                                               id="name" name="name" value="{{ old('name', $place->name) }}" placeholder="Nama Destinasi" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select glass-input @error('category') is-invalid @enderror"
                                            ...
                                            <option value="Gunung" {{ old('category', $place->category) == 'Gunung' ? 'selected' : '' }}>Gunung</option>
                                            <option value="Danau" {{ old('category', $place->category) == 'Danau' ? 'selected' : '' }}>Danau</option>
                                            <option value="Hutan" {{ old('category', $place->category) == 'Hutan' ? 'selected' : '' }}>Hutan</option>
                                            <option value="Air Terjun" {{ old('category', $place->category) == 'Air Terjun' ? 'selected' : '' }}>Air Terjun</option>
                                            <option value="Camping" {{ old('category', $place->category) == 'Camping' ? 'selected' : '' }}>Camping</option>
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control glass-input @error('location') is-invalid @enderror"
                                               id="location" name="location" value="{{ old('location', $place->location) }}" placeholder="Lokasi" required>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control glass-input @error('description') is-invalid @enderror"
                                                  id="description" name="description" placeholder="Deskripsi" style="height: 120px;" required>{{ old('description', $place->description) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control glass-input @error('rating') is-invalid @enderror"
                                               id="rating" name="rating" value="{{ old('rating', $place->rating) }}" placeholder="Rating" min="0" max="5" step="0.1" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control glass-input @error('visitors') is-invalid @enderror"
                                               id="visitors" name="visitors" value="{{ old('visitors', $place->visitors) }}" placeholder="Jumlah Pengunjung" min="0" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control glass-input @error('opening_hours') is-invalid @enderror"
                                               id="opening_hours" name="opening_hours" value="{{ old('opening_hours', $place->opening_hours) }}" placeholder="Jam Operasional">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control glass-input @error('ticket_price') is-invalid @enderror"
                                               id="ticket_price" name="ticket_price" value="{{ old('ticket_price', $place->ticket_price) }}" placeholder="Harga Tiket" min="0">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="url" class="form-control glass-input @error('maps_url') is-invalid @enderror"
                                               id="maps_url" name="maps_url" value="{{ old('maps_url', $place->maps_url) }}" placeholder="URL Google Maps">
                        ...
                        <div class="mb-4">
                                        ...
                                        <div class="upload-content">
                                            @if($place->image)
                                                <div class="current-media">
                                                    <img src="{{ asset('storage/' . $place->image) }}" alt="Current Image" style="max-width: 100%; max-height: 150px; border-radius: 10px; margin-bottom: 1rem;">
                                                    <div class="text-light opacity-75 mb-2">Gambar saat ini</div>
                                                </div>
                                            @endif
                                            <i class="fas fa-cloud-upload-alt upload-icon"></i>
                                            <div class="upload-text">Klik untuk ganti gambar</div>
                                ...
                                <div class="col-md-6">
                                    <div class="upload-area" id="videoUpload">
                                        ...
                                        <div class="upload-content">
                                            @if($place->video_path)
                                                <div class="current-media">
                                                    <video controls style="max-width: 100%; max-height: 150px; border-radius: 10px; margin-bottom: 1rem;">
                                                        <source src="{{ asset('storage/' . $place->video_path) }}" type="video/mp4">
                                                    </video>
                                                    <div class="text-light opacity-75 mb-2">Video saat ini</div>
                                                </div>
                                            @endif
                                            <i class="fas fa-video upload-icon"></i>
                                            <div class="upload-text">Klik untuk ganti video</div>
                                            <div class="upload-subtext">atau drag & drop di sini</div>
                            ...
                            <div class="mt-4">
                                <label for="photos" class="form-label" style="color: #ffffff; font-weight: 600;">Tambah Foto Galeri</label>
                                        ...
                                        @foreach($place->photos as $photo)
                                            <div class="col-md-4">
                                                <div class="gallery-admin-photo">
                                                    <img src="{{ asset('storage/' . $photo->path) }}" alt="Foto galeri {{ $loop->iteration }}">
                                                    <label>
                        ...
                        <div class="d-flex gap-3 justify-content-end">
                            <a href="{{ route('places.show', $place) }}" class="btn btn-secondary-modern">
                                <i class="fas fa-eye me-2"></i>Lihat Destinasi
                            </a>
